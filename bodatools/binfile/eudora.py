# file bodatools/binfile/eudora.py
#
 ...
 * :class:`Toc` -- a :class:`~bodatools.binfile.BinaryStructure` for the index
   file header
 * :class:`Message` -- a :class:`~bodatools.binfile.BinaryStructure` for the
...
class Toc(binfile.BinaryStructure):
    '''A :class:`~bodatools.binfile.BinaryStructure` for an email folder index
    header.
...
class Message(binfile.BinaryStructure):
    '''A :class:`~bodatools.binfile.BinaryStructure` for a single email's
