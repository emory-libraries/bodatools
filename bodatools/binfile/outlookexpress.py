# file bodatools/binfile/outlookexpress.py
#
...
class MacIndex(binfile.BinaryStructure):
    '''A :class:`~bodatools.binfile.BinaryStructure` for the Index
...
class MacMail(binfile.BinaryStructure):
    '''A :class:`~bodatools.binfile.BinaryStructure` for the Mail file
